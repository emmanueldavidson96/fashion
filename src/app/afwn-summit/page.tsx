...
import {base_afwn_summit} from '../../../api/base';
...
export default function page() {
    ...
    const handle_submit = (event:React.FormEvent<HTMLFormElement>) => {
        ...
        base_afwn_summit("AFWNSummit").create({
            Name, Gender, Company, Contact, Email, Phone
  ...
  return (
    <div className=''>
        ...
        <div className='h-[400px] w-full bg-black flex gap-5 flex-col items-center justify-center'>
            <h2 className='text-2xl text-center w-[90%] mx-auto lg:text-4xl font-extrabold uppercase text-white mt-8'>AFWN Summit </h2>
            ...
            <div className='w-[92%] mx-auto flex max-lg:flex-col max-lg:gap-8 justify-between'>                
                <div className='lg:w-[48%] w-full  flex flex-col gap-4'>
                    <form className='w-full mx-auto flex flex-col gap-6' onSubmit={handle_submit}>
                        <label className='text-2xl lg:text-4xl text-black font-bold uppercase'>AFWN Summit Form</label>
                        <input onChange={(e) => setName(e.target.value)} type="text" name="" id="" className='w-full px-6 py-3 border-b text-black border-green-500' placeholder='Contact Name' />
                        ...
                        <input type="text" onChange={(e) => setCompany(e.target.value)} name='' id='' className='w-full px-6 py-3 border-b text-black border-green-500' placeholder='Company Name'/>
                        <input type="text" name='' onChange={(e) => setContact(e.target.value)} id='' className='w-full px-6 py-3 text-black border-b border-green-500' placeholder='Contact Designation'/>
                        <input type="email" onChange={(e) => setEmail(e.target.value)} name='' id='' className='w-full px-6 py-3 border-b text-black border-green-500' placeholder='Email Address'/>
                        <input type="text" onChange={(e) => setPhone(e.target.value)} name='' id='' className='w-full px-6 py-3 text-black border-b border-green-500' placeholder='Phone Number'/>
