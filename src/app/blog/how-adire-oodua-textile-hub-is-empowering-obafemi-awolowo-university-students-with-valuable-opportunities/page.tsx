        ...
        <div className='h-fit w-full'>
            <div className='h-[500px] max-lg:h-[400px] overflow-hidden flex flex-col gap-3 justify-center mt-[80px] py-12 relative'>
                ...
                <div className='flex flex-col gap-5 bg-black top-0 left-0 bottom-0 px-12 pt-36 absolute opacity-80 '>
                    <h2 className='text-white text-5xl font-semibold capitalize max-lg:text-2xl'>africa fashion week partners with manchester metropolitan university to globalize nigerian adire textiles</h2>
