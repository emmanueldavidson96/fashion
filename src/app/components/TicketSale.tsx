  ...
  return (
    <div className='w-screen h-fit py-24 flex flex-col items-center justify-center gap-5 p-5'>
        <motion.h2 
            ...
            className='lg:text-6xl text-3xl font-extrabold uppercase text-center'>AFWN2025 Entry & Ticket Purchase</motion.h2>
        <motion.h3 
            variants={fadeIn("up", 0.4)}
            initial="hidden"
            whileInView={"show"}
            viewport={{once:false, amount:0.3}}
            className='lg:text-4xl text-xl text-center font-extrabold '>Saturday 9th November - Sunday 10th November</motion.h3>
